...
Testing BinarizeImageApiService
...
func Test_asposeocrcloud_BinarizeImageApiService(t *testing.T) {
	...
	t.Run("Test BinarizeImageApiService", func(t *testing.T) {

		// t.Skip("skip test") // remove to run test

		filePath := "../samples/binarization.jpeg" // Path to your file
		...
		requestBody := *asposeocrcloud.NewOCRBinarizeImageBody(fileb64Encoded)
		taskId, httpRes, err := apiClient.BinarizeImageApi.PostBinarizeImage(context.Background()).OCRBinarizeImageBody(requestBody).Execute()
		...
		ocrResp, httpRes, err := apiClient.BinarizeImageApi.GetBinarizeImage(context.Background()).Id(taskId).Execute()
