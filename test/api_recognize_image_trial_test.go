...
Testing RecognizeImageTrialApiService
...
func Test_asposeocrcloud_RecognizeImageTrialApiService(t *testing.T) {
	...
	t.Run("Test RecognizeImageTrialApiService", func(t *testing.T) {
		...
		*recognitionSettings.MakeContrastCorrection = false
		...
		taskId, httpRes, err := apiClient.RecognizeImageTrialApi.PostRecognizeImageTrial(context.Background()).OCRRecognizeImageBody(requestBody).Execute()
		...
		ocrResp, httpRes, err := apiClient.RecognizeImageTrialApi.GetRecognizeImageTrial(context.Background()).Id(taskId).Execute()
