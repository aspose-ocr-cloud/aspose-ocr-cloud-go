...
// checks if the OCRSettingsRecognizeImage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OCRSettingsRecognizeImage{}
...
func NewOCRSettingsRecognizeImage() *OCRSettingsRecognizeImage {
	this := OCRSettingsRecognizeImage{}
...
type NullableOCRSettingsRecognizeImage struct {
	value *OCRSettingsRecognizeImage
	isSet bool
}

func (v NullableOCRSettingsRecognizeImage) Get() *OCRSettingsRecognizeImage {
	return v.value
}

func (v *NullableOCRSettingsRecognizeImage) Set(val *OCRSettingsRecognizeImage) {
	v.value = val
	v.isSet = true
}

func (v NullableOCRSettingsRecognizeImage) IsSet() bool {
	return v.isSet
}

func (v *NullableOCRSettingsRecognizeImage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOCRSettingsRecognizeImage(val *OCRSettingsRecognizeImage) *NullableOCRSettingsRecognizeImage {
	return &NullableOCRSettingsRecognizeImage{value: val, isSet: true}
}
