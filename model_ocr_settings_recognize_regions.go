...
// checks if the OCRSettingsRecognizeRegions type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OCRSettingsRecognizeRegions{}
...
func NewOCRSettingsRecognizeRegions() *OCRSettingsRecognizeRegions {
	this := OCRSettingsRecognizeRegions{}
...
type NullableOCRSettingsRecognizeRegions struct {
	value *OCRSettingsRecognizeRegions
	isSet bool
}

func (v NullableOCRSettingsRecognizeRegions) Get() *OCRSettingsRecognizeRegions {
	return v.value
}

func (v *NullableOCRSettingsRecognizeRegions) Set(val *OCRSettingsRecognizeRegions) {
	v.value = val
	v.isSet = true
}

func (v NullableOCRSettingsRecognizeRegions) IsSet() bool {
	return v.isSet
}

func (v *NullableOCRSettingsRecognizeRegions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOCRSettingsRecognizeRegions(val *OCRSettingsRecognizeRegions) *NullableOCRSettingsRecognizeRegions {
	return &NullableOCRSettingsRecognizeRegions{value: val, isSet: true}
}
